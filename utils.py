...
def apply_noise(input, noise_type, noise_level, mean=0.0, gpu=True, args=None):
    ...
    if noise_type == 'Gaussian':
        ...
        noise = noise.cuda(0) if gpu else noise
        output = input + noise
        ...
        mask = mask.cuda(0) if gpu else mask
        output = input * mask
        ...
        output = output.cuda(0) if gpu else output
